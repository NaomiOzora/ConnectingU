                ...
                <div class="flex flex-col lg:flex-row items-center gap-12">
                    ...
                    <div class="lg:w-1/2 text-center lg:text-left">
                        <span class="inline-block py-1 px-3 rounded-full bg-blue-50 text-secondary text-sm font-bold mb-6 border border-blue-100">
                            🚀 Platform Kolaborasi Mahasiswa No.1 di Indonesia
                        </span>
                        ...
                        <div class="mt-10 flex items-center justify-center lg:justify-start gap-4 text-sm text-gray-500 font-medium">
                            ...
                            <p>500+ Mahasiswa telah Bergabung dengan Komunitas Kami</p>
                        </div>
                    </div>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                    ...
                    <div class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-lg transition flex items-center gap-6 text-left">
                        ...
                        <img src="{{ asset('images/ichsan.png') }}" alt="Mohammad Ichsan Nurdin" class="w-20 h-20 rounded-full border-4 border-blue-50 object-cover">
                        <div>
                    ...
                    <div class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-lg transition flex items-center gap-6 text-left">
                        {{-- Mengganti placeholder dengan foto asli --}}
                        <img src="{{ asset('images/iqbal.png') }}" alt="Iqbal Umar Kadafi" class="w-20 h-20 rounded-full border-4 border-indigo-50 object-cover">
                        <div>
